export const environment = {
  production: false,
  seguridad: false,
  API_GESTOR: "https://rtu.desa.sat.gob.gt/api/sat-gestor-app",
  API_GENERAL: "https://rtu.desa.sat.gob.gt/api/sat_general",
  API_RTU: "https://rtu.desa.sat.gob.gt/api/sat_rtu",
